...
DISCORD_TOKEN = os.environ.get('FACTORIO_DISCORD_TOKEN')
CHANNEL_ID = int(os.environ.get('FACTORIO_DISCORD_CHANNEL'))
...
class MyClient(discord.Client):
    ...
    async def on_ready(self):
        ...
        if channel == None:
            print('Channel {} not found'.format(CHANNEL_ID))
            exit(1)
        ...
        for changelog in self.changelogs:
            ...
            for embed in embeds:
               ...
               print('Posted message: {}'.format(embed.title))
